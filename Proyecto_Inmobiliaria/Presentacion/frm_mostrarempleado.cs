...
{
    public partial class frm_mostrarempleado : Form
    {
        public frm_mostrarempleado()
        {
            InitializeComponent();
        }
        ...
        private void listargrilla()
        {
            try
            {
                dgvlistarp.DataSource = PersonaNegocio.ListarE();
                this.TitulosGrilla();
                //this.limpiar();
                //this.Visualizar();
        ...
        private void frm_mostrarempleado_Load(object sender, EventArgs e)
        {
            this.listargrilla();
        }
