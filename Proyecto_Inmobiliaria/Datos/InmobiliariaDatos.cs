...
namespace Datos
{
    public class InmobiliariaDatos
    {
        //listar
        public DataTable listarP()
        {
            ...
            try
            {
                ...
                SqlCommand comando = new SqlCommand("USP_Inmobiliaria_S", SqlCnx);
        ...
        //insertar
        public string InsertarP(ClsInmueble objpersona)
        {
            string rpta = "";
            SqlConnection SqlCnx = new SqlConnection();
            try
            {
                SqlCnx = Conexion.GetInstancia().Establecerconexion();
                SqlCommand comando = new SqlCommand("USP_Inmueble_A", SqlCnx);
                comando.CommandType = CommandType.StoredProcedure;
                ...
                comando.Parameters.Add("@ptipoinmueble", SqlDbType.Char).Value = objpersona.Tipoinmueble;
